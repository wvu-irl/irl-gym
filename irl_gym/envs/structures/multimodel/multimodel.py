"""
This module contains the MultiModelEnv for planning with multiple models
"""
__license__ = "BSD-3"
...
##TODO: 
# Do I need to define a global space? and if so, how to specify? Do separately without model or pull from specific model?
    # First case is advantageous because it allows for a global state space without a model 
    # Alternatively, by providing the mappings I don't need a global space, instead I can rely on the mappings to define the global space. 
        # But then I would not want to use Gynmasium to get around their constaints. Not a problem, as I plan to do this at some point anyways.    

class MultiModelEnv(Env):
    """   
    MultiModelEnv for planning with multiple models
