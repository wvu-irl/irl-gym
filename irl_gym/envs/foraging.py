"""
This module contains the ForagingEnv for finding samples and returning them to a base station.
"""
__license__ = "BSD-3"
...
class ForagingEnv(Env):
    """   
    Foraging where agent seeks out samples and returns them to a base station.
    ...
    **Observations**
        ...
        Agent position, battery is fully observable
